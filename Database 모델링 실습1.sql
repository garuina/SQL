...
insert into `professors` values('P10101', 10, '김유신', '780120-1234567', '010-1101-1976', 'kimys@hg.ac.kr', '서울');
...
insert into `professors` values('P22110', 22, '정보고', '780727-1234567', '010-3101-1979', 'jangbg@hg.ac.kr', '대구');
insert into `professors` values('P23102', 23, '선덕여왕', '890614-1234567', '010-4101-1984', 'gueen@hg.ac.kr', '대구');
